...
MEEGO_V=$(get_version_component_range 5-7)
MEEGO_VV=$(get_version_component_range 5-10)

MY_PV=$(get_version_component_range 1-2)-$(get_version_component_range 3-4)
...
SRC_URI="http://repo.meego.com/MeeGo/builds/${MEEGO_V}/${MEEGO_VV}/repos/oss/source/${MY_P}.src.rpm"
